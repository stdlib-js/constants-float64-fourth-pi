...
```javascript
FOURTH_PI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-fourth-pi@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-fourth-pi/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/constants-float64-fourth-pi/actions/workflows/test.yml?query=branch:v0.2.1
